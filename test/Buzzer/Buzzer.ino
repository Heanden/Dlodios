/*
 * @Author: your name
 * @Date: 2019-12-14 20:22:35
 * @LastEditTime: 2019-12-15 16:44:53
 * @LastEditors: your name
 * @Description: In User Settings Edit
 * @FilePath: \Dlodios\test\Buzzer\Buzzer.ino
 */
#define NOTE_D0 -1
#define NOTE_D1 294
#define NOTE_D2 330
...
float duration[] =
    {
        ...
        0.5, 1, 0.5, 1 + 1,
        1 + 1, 0.5, 0.5, 1,
        1 + 1 + 1 + 1}; //这部分是整首曲子的接拍部分，也定义个序列duration，浮点（数组的个数和前面音符的个数是一样的，一一对应么）
